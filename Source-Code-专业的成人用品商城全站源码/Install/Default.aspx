<%@ page language="C#" autoeventwireup="true" inherits="Install_Default, App_Web_o1rfibwn" responseencoding="utf-8" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %><!DOCTYPE html>
    ...
    <div class="container content_body text-left" style="max-width: 700px;">
        <div class="form-group">
            ...
            <span class="margin_l20">
                <a href="http://www.z01.com/Item/2977.aspx" target="_blank" class="btn btn-info"><i class="glyphicon glyphicon-question-sign"></i><%=Resources.L.未安装数据库 %></a>
            </span>
        </div>
        <div class="form-group">
