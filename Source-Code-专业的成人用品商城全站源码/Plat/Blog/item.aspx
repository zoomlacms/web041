<%@ page language="C#" autoeventwireup="true" inherits="Plat_Blog_ContentDetail, App_Web_aqg0ksfz" masterpagefile="~/Plat/Main.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div class="container">
    <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 col-md-offset-2 col-lg-offset-2 platcontainer">
        ...
        <span class="glyphicon glyphicon-comment colorfix send_reply"></span><strong class="colorfix">发表评论</strong>
