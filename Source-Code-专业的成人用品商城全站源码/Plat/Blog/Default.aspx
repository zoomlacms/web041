<%@ page language="C#" autoeventwireup="true" enablesessionstate="True" inherits="Plat_Task_Default, App_Web_aqg0ksfz" masterpagefile="~/Plat/Main.master" validaterequest="false" enableviewstate="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <div class="comp_body">
        ...
        <div class="comp_content">
            <asp:Repeater ID="Cate_RPT" runat="server" EnableViewState="false" OnItemDataBound="Cate_RPT_ItemDataBound">
                <ItemTemplate>
                  <%--  <div class="panel-heading">
                        <h3 class="panel-title"><%#Eval("Catename") %> <a title="在该板块发表贴子" target="_blank" href="/EditContent?ID=-1&Cid=<%#Eval("Cateid") %>"><span class="glyphicon glyphicon-plus-sign" style="color: #1796BF;"></span></a><span class='badge pull-right'><a target="_blank" style="color: white;" href='/PClass?id=<%#Eval("Cateid") %>'>more</a></span></h3>
                    </div>--%>
                    <ul class="list-group">
...
<script>
    ...
    event: function ($div) {
        ...
        InitAt($div);
        console.log($div,$div.find(".reply_text").length);
    }
};
</script>
</asp:Content>