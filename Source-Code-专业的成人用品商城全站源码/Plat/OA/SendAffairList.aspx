<%@ page language="C#" autoeventwireup="true" inherits="MIS_ZLOA_Office_Send, App_Web_q1j4sajx" masterpagefile="~/Plat/Main.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div class="input-group nav_searchDiv">
  ...
  <asp:LinkButton runat="server"  style="height:34px;" CssClass="btn btn-default" ID="searchBtn" OnClick="searchBtn_Click"><span style="margin-top:2px;" class="glyphicon glyphicon-search"></span></asp:LinkButton>
  </span> </div>
