<%@ page language="C#" autoeventwireup="true" inherits="test_chat, App_Web_3i1e4gb2" clientidmode="Static" validaterequest="false" enableviewstate="false" masterpagefile="~/Common/Master/Empty.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<span class="chat_top_r" data-toggle="tooltip" data-placement="left" title="点击查看历史记录"><a href="javascript:;" onclick="ShowHistory();"><i class="fa fa-list-alt"></i> 历史记录</a></span>
</div>
<div class="chat_main">
...
<ItemTemplate>
<li onclick="ChangeTalker(<%#"'"+Eval("UserID")+"','"+Eval("UserName")+"'" %>);" class="media" id="list_item_<%#Eval("HoneyName") %>">
...
您可以通过UID来指定聊天对象，如：/Common/Chat/Chat.aspx?uid=1
</div>
</div>
...
function GetToReg() {
if (parent) { parent.location = "/User/Register.aspx"; } else { location = "/User/Register.aspx"; }
}
function AJAXLogin() {
...
toolbars: [['Undo', 'Redo', 'Bold', 'Italic', 'NumberedList', 'BulletedList', 'Smiley', 'ShowBlocks', 'Maximize', 'underline', 'fontborder', 'strikethrough', '|', 'justifyleft', 'justifycenter', 'justifyright', 'justifyjustify', 'emotion']]
});
//监控回车事件
setTimeout(function () {
chatue.focus();
...
$('.list_search').show();
var listhtml = "";
var temp = "<li onclick=\"ChangeTalker(@fid,'@UserName');\" class='list_item' id='list_item_@fid'><img src='@UserFace' class='member_face' onerror=\"shownoface(this);\" /><p class='member_nick'>@UserName<br /><span class='isonline remindgray isonline_@fid'>(检测中)</span><span id='unread_@fid' class='badge'></span></p><div style='clear:both;'></div></li>";
