<%@ page language="C#" autoeventwireup="true" inherits="Common_Dialog_SelGroup, App_Web_mxnmrrkh" masterpagefile="~/Common/Common.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <script>
        var B_Users = {
            ...
            LoadMore: function () {
                ...
                url += "source=<%=Source %>&skey=" + encodeURI(ref.conf.skey) + "&psize=" + ref.conf.psize + "&PIndex=" + ref.conf.page + "&groupid=" + ref.conf.groupid + "&char=" + ref.conf.char;
