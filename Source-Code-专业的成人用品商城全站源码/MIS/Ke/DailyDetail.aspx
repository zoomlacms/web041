<%@ page language="C#" autoeventwireup="true" inherits="Plat_Blog_Declined, App_Web_glrcgqwc" masterpagefile="~/Plat/Empty.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
  ...
  <div>
    <div style="padding-left:1em; ">
      <table id="DetailTable">
          <tr>
              <td><span class="glyphicon  glyphicon-map-marker"></span> <span>名称： </span></td>
              <td>
                   <asp:TextBox runat="server" ID="Name" CssClass="form-control date" />
                   <asp:LinkButton runat="server" ID="Del_Btn" OnClick="Del_Btn_Click" OnClientClick="return confirm('确定要删除吗!!');"> <span class="glyphicon glyphicon-trash" title="删除"></span></asp:LinkButton>
              </td>
          </tr>
        <tr>
        ...
        <tr>
          <td colspan="2"><label><asp:CheckBox runat="server" ID="IsOpen_Chk" />
            <span class="glyphicon glyphicon-lock"></span><span>公开日程</span></label></td>
        </tr>
        <tr>
