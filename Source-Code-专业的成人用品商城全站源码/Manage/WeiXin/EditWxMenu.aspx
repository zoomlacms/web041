<%@ page language="C#" autoeventwireup="true" inherits="Manage_WeiXin_EditWxMenu, App_Web_xh4p533v" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <script>
        ...
        function InitMenu() {
            ...
            //父菜单模板
            var menutlp = "<span class='glyphicon glyphicon-list-alt'></span> <input type='text' value='@name' class='form-control text_s' onchange='EditMenu(this,@index);'/>"
            ...
            var childtlp = "<span class='glyphicon glyphicon-chevron-right'></span> <span class='glyphicon glyphicon-edit'></span>  <input type='text' value='@name' class='form-control text_s' onchange='EditMenu(this,@index);'/>"//子菜单模板
