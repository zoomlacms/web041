<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Content_EditSinglePage, App_Web_p0na0yyv" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<%--                    <tr>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-top:10px;">
        <tr>
            ...
            <asp:Button ID="Cencel_B" runat="server" CssClass="btn btn-primary" OnClick="Cencel_B_Click" />
            </td>
        </tr>
    </table>
