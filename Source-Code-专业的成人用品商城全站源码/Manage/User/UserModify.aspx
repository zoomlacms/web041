<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.User.UserPassModify, App_Web_budr42io" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <div class="tab-pane" id="Tabs3">
            <table class="table table-striped table-bordered table-hover padding0">
                ...
                <tr>
                    ...
                    <td><asp:TextBox ID="tbPost_T" CssClass="form-control text_md" runat="server"></asp:TextBox></td>
