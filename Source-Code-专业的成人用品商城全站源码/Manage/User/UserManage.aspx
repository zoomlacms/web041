<%@ page language="C#" autoeventwireup="true" inherits="Manage_User_UserManage, App_Web_budr42io" title="会员管理" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<asp:Content runat="server" ContentPlaceHolderID="head" EnableViewState="false">
<title><%=Resources.L.会员管理 %></title>
<style>.order_img {display: none;}.row{margin-bottom:25px;}</style>
</asp:Content>
