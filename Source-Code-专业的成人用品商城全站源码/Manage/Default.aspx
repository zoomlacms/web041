<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Default, App_Web_53ya2qsf" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html>
<head>
    ...
    <div class="m_top">
        ...
        <div class="m_top_bottom hidden-xs">
            ...
            <ul class="menu11">
                ...
                <li class="menu11_11"><a onclick="showleft('menu11_11','design/TlpList.aspx?type=1')">H5场景</a></li>
            </ul>
        </div>
    </div>
    <div class="m_main">
                    ...
                    <ul class="m_left_ulin" id="menu11_10">
                        ...
                        <li>
                            <div class="input-group ">
                                ...
                                <span class="input-group-btn">
                                    <button class="btn btn-default" type="button" onclick="ASCX.Search('design/SiteList.aspx?KeyWord=','site_text');"><span class="glyphicon glyphicon-search"></span></button>
                                </span>
                            </div>
                        </li>
                        ...
                        <li id="menu11_10_8"><a href="javascript:;" data-url="design/ResList.aspx">资源管理</a></li>
                        <li id="menu11_10_9"><a href="javascript:;" data-url="design/Config.aspx">动力配置</a></li>
                    </ul>
                    <ul class="m_left_ulin" id="menu11_11">
                        ...
                        <li>
                            <div class="input-group ">
                                ...
                                <span class="input-group-btn">
                                    <button class="btn btn-default" type="button" onclick="ASCX.Search('design/SceneList.aspx?KeyWord=','scence_text');" ><span class="glyphicon glyphicon-search"></span></button>
                                </span>
                            </div>
                        </li>
                        <li id="menu11_11_1"><a href="javascript:;" data-url="design/TlpList.aspx?type=1">场景模板</a></li>
                        <li id="menu11_11_2"><a href="javascript:;" data-url="design/SceneList.aspx">用户场景</a></li>
