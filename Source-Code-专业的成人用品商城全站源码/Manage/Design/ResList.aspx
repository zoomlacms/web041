<%@ page language="C#" autoeventwireup="true" inherits="Manage_Design_ResList, App_Web_mdhofeiu" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        CssClass="table table-striped table-bordered table-hover" EnableTheming="False" EnableModelValidation="True" EmptyDataText="数据为空">
         <Columns>
             ...
             <asp:TemplateField HeaderText="操作">
	            <ItemTemplate> 
                  <a href="AddRes.aspx?id=<%#Eval("ID") %>" title="修改" class="option_style"><span class="glyphicon glyphicon-pencil"></span></a>
	              <asp:LinkButton runat="server" CssClass="option_style" CommandName="Del" CommandArgument='<%#Eval("ID") %>' OnClientClick="return confirm('你确定要删除吗!');" ToolTip="删除"> <span class="glyphicon glyphicon-trash"></span>删除</asp:LinkButton>
	            </ItemTemplate>
             </asp:TemplateField>
         </Columns>
     </ZL:ExGridView>
