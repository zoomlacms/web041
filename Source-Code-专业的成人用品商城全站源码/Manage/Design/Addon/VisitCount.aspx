<%@ page language="C#" autoeventwireup="true" inherits="Manage_Design_Addon_VisitCount, App_Web_1pasogmn" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div id="template" runat="server" class="template">
    <ol class="breadcrumb navbar-fixed-top">
        ...
        <li><a href='../SceneList.aspx'>用户场景</a></li>
    ...
    <div class="template">
        <ul class="nav nav-tabs hidden-xs hidden-sm">
            <li><a href="#tab_detail" data-toggle="tab" onclick="showtabs('detail')">访问详情</a></li>
        ...
        <ZL:ExGridView ID="EGV" runat="server" AutoGenerateColumns="False" PageSize="20" IsHoldState="false" BoxType="dp"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="场景标题">
                    <ItemTemplate>
                        <a href="/design/h5/preview.aspx?id=<%#Eval("InfoID") %>" target="_blank" title="浏览"><%#Eval("InfoTitle") %></a>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <ZL:ExRepeater runat="server" ID="RPT" PageSize="20" PagePre="<tr id='page_tr'><td colspan='11' id='page_td'>" PageEnd="</td></tr>">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td>
                                <a href="VisitCount.aspx?seky=<%#Eval("InfoTitle") %>&view=detail" title="访问统计"><i class="fa fa-list-ul"></i>详情</a>
                                <a href="/design/h5/preview.aspx?id=<%#Eval("InfoID") %>" target="_blank" title="浏览"><i class="fa fa-globe"></i>浏览</a>
                            </td>
                        </tr>
                    </ItemTemplate>
