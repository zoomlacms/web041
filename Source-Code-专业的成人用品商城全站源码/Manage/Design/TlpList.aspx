<%@ page language="C#" autoeventwireup="true" inherits="Manage_Design_TlpList, App_Web_mdhofeiu" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                    ...
                    <ItemTemplate>
                        <li class="padding5">
                            <div class="Template_box">
                                ...
                                <span class="pull-left margintop-8"><strong>[<%#GetClassName() %>]<%#GetStatus() %></strong> <%#Eval("TlpName") %></span>
