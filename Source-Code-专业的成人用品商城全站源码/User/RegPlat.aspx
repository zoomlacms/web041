<%@ page language="C#" autoeventwireup="true" inherits="User_RegPlat, App_Web_pqaxfd5n" masterpagefile="~/Common/Master/Empty.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<h1 class="regplat_title" style="color:#fff;">连接世界的力量</h1>
    ...
    <div runat="server" id="Step3_Div" visible="false"> 
        <ul class="detail_ul">
            <li class="descli" style="color:white;"><span class="glyphicon glyphicon-user"></span> <asp:Label runat="server" ID="UserName_L" /></li>
