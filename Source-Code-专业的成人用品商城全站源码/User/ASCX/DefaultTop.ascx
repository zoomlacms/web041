<%@ control language="C#" autoeventwireup="true" inherits="User_ASCX_DefaultTop, App_Web_0lcida0y" %>
...
<li class="hidden-xs"><div class="u_search_form"><input type="text" name="key" id="key" class="form-control" placeholder="快速搜索" onKeyDown="return IsEnter(this);" /><i class="glyphicon glyphicon-search" id="sub_btn" title="可按回车键快速检索"></i></div></li>
