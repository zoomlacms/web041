<%@ page language="C#" autoeventwireup="true" inherits="Design_mbh5_Default, App_Web_ixzafad0" masterpagefile="~/Common/Master/Empty.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<title><asp:Literal runat="server" ID="Title_L" /></title>
</asp:Content>
...
<a href="javascript:;" onclick="showmenu();" class="header back link_btn">
    ...
    <ul id="titmenu" class="list-unstyled menu_vertical">
        <li class="item link_btn" onclick="location.href='https://v.z01.com/design/user/default2.aspx';">我的<br />场景</li>
        <li class="item link_btn" onclick="mbh5.pop.show('edit');">修改<br />参数</li>
    </ul>
</a>
<a href="javascript:;" class="header view link_btn" onclick="mbh5.preview();" style="width:80px;height:80px;padding-top:10px;">保存<br />预览</a>
...
<div ng-app="app">
    <div class="swiper-container editor scence">
    ...
    <div ng-controller="footCtrl">
        <div class="footer">
            <a href="javascript:;" onclick="mbh5.foot.show(70,'addpage')">
            ...
            <a href="javascript:;"  onclick="mbh5.foot.show(70,'setbk')">
                <i class="fa fa-th"></i>
                <span>背景</span>
            </a>
      ...
      <%--      <a href="javascript:;" onclick="mbh5.comp.addbtn();">
        ...
        <div class="footcmd addpage" id="addpage_div">
            <div class="footcmd_head">
                <div class="head_tab_wrap">
                    <input type="button" value="删除" class="btn btn-danger" style="width:100px;height:60px;font-size:30px;" ng-click="scence.del();" />
                </div>
                <div class="head_yes">
                    <a onclick="CloseDiag();" class="btn btn-default"><i class="fa fa-remove"></i></a>
                </div>
            ...
            <div class="footcmd_ul_wrap">
                <ul class="footcmd_ul">
                    <li ng-repeat="item in scence.list track by $index" ng-class="scence.isactive(item)?'active':''" ng-click="scence.switch(item);">
        ...
        <div class="footcmd setbk" id="setbk_div">
            <div class="footcmd_head">
                <div class="head_tab_wrap">
                    <input type="button" value="清除" class="btn btn-danger" ng-click="diy_bk.del();" />
                </div>
                <div class="head_yes">
                    <a onclick="CloseDiag();" class="btn btn-default"><i class="fa fa-remove"></i></a>
                </div>
