<%@ page language="C#" autoeventwireup="true" inherits="Design_mobile_pop_list, App_Web_u3xwcpzj" masterpagefile="~/Design/Master/MB_POP.master" enableviewstate="false" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div class="page-group" ng-app="app">
    <div id="page_list" class="page page-current" ng-controller="APPCtrl">
        <header class="bar bar-nav">
            <a href="javascript:;" class="button button-link button-nav pull-left" ng-click="save();"><i class="fa fa-chevron-left"></i></a>
                    ...
                    <li>
                        <div class="item-content">
                            <div class="item-inner">
                                ...
                                <a href="#page_icons" class="button button-fill">选择</a>
                            </div>
                        </div>
                    </li>
                    <li>
                    ...
                    <li onclick="openEditor();">
                         <div class="item-content">
                            <div class="item-inner">
                                ...
                                <div class="item-input" id="content_div">   
                                </div>
                            </div>
                        </div>
                    </li>
    ...
    <div id="page_icons" class="page">
        <header class="bar bar-nav">
            <a href="#page_content" class="button button-link button-nav pull-left back"><i class="fa fa-chevron-left"></i></a>
...
.list_item .op_wrap {text-align:center;display:table-cell;width:80px;vertical-align:middle;color:#ccc;}
...
<script>
    ...
    var page = { scope: null, listscope: null, backup: "" };//内容scope
    angular.module("app", [])
    .controller("APPCtrl", function ($scope, Data) {
        page.listscope = $scope;
    ...
    .controller("ConCtrl", function ($scope, Data) {
        ...
        $scope.save = function () {
            ...
            if ($scope.model.id == "") {
                //提交至后台,并将其加入数组
                Zepto.showPreloader();
                top.tools.updatedata("mb_new", { "list": list }, function (data) {
                    $scope.model.id = data;
                    page.listscope.list.push($scope.model);
                    page.listscope.$digest();
                    Zepto.hidePreloader();
                    Zepto.router.back("#page_list");
                })
            }
    ...
    <div style="background-color:#b6ff00"></div>
</asp:Content>