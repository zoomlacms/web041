<%@ page language="C#" autoeventwireup="true" inherits="Design_Diag_Common_animate, App_Web_wjmwfsmv" masterpagefile="~/Design/Master/Edit.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<table class="table table-bordered table-striped" ng-controller="appCtrl">
    ...
    <select ng-model="animate.effect" ng-change="play();">
        ...
        <optgroup label="弹入">
          ...
          <option value="bounceInUp">从下弹出</option>
        </optgroup>
        <optgroup label="弹出">
