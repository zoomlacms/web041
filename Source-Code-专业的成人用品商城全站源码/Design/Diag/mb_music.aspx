<%@ page language="C#" autoeventwireup="true" inherits="Design_Diag_mb_music, App_Web_qopbkcoy" masterpagefile="~/Design/Master/Edit.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<style>
.div_title{height:75px;font-size:30px;padding-top:20px; text-align:center;position:fixed;top:0px;width:100%;background-color:#fff;}

.mb_music .scroll_wrap{margin-top:80px;margin-bottom:90px;}/*margin-top:80px;margin-bottom:90px;*/
